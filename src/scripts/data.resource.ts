...
let resources:Collection<Resource> = new Collection('Resources', [food, prod, stone, fish, cattle, spices, banana, gold, gems, oil, iron, steel, uranium, chihuahua, spaghetti, horse]);

...
let pearls:Resource = new Resource('pearls', 0, 0, -1, 0, 'pearls', 'Pearls make a popular accessory amongst your empire\'s wealthiest. They provide extra <img src="img/happy.png"> based on your economy\'s vibrancy. They are once in a seldom while found by citizens after you build a Harbor.', false, true);
...
let resources:Collection<Resource> = new Collection('Resources', [food, prod, stone, fish, cattle, spices, banana, gold, gems, oil, iron, steel, uranium, chihuahua, spaghetti, horse, silver, pearls, whale]);

...
let sailing:Tech = new Tech('sailing', 'ancient', 'It\'s a lot harder to sail if you stay at half-mast!', ['Grants 10 free <img src="img/fish.png">', 'Can assign soldiers as Navy.', 'Can meet Coastal and Oceanic Nations.']);

var game = {
  ...
  init: function() {
    ...
    var updateMoney = function(amt) {
      if (amt == null || amt == '') {
        amt = (((((game.empire.pop - game.empire.popUnemployed) * 2) - (game.empire.popUnemployed * 5) + (game.citizens.merchants.num * game.citizens.merchants.pm)) * game.empire.cashMult) - (calcBuildingCost() + calcUnitCost()))  / 60;
      } else {
        amt = amt;
      }
